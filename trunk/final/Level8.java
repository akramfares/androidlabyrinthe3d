...
public class Level8 extends SimpleApplication implements ActionListener,PhysicsCollisionListener{
	private static Level8 app;
	...
	// --------------- Terrain 1 -------------------
		...
		// ----------- Cube 1 ---------
		CubeObstacle c1 = new CubeObstacle(10f, 0.6f, 0.6f, ColorRGBA.Blue);
		c1.getGeom().move(-8,-7,-17); 
		// ----------- Cube 2 ---------
		CubeObstacle c2 = new CubeObstacle(17, 0.6f, 0.6f, ColorRGBA.Blue);
		c2.getGeom().move(4.5f,-7,-10); 
		// ----------- Cube 3 ---------
		CubeObstacle c3 = new CubeObstacle(0.6f, 0.6f, 10f, ColorRGBA.Blue);
		c3.getGeom().move(-12f,-7,0.2f); 
		// ----------- Cube 4 ---------
		CubeObstacle c4 = new CubeObstacle(16f, 0.6f, 0.6f, ColorRGBA.Blue);
		c4.getGeom().move(3.5f,-7,10.5f); 
